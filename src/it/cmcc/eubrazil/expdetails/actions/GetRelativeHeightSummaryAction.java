...
public class GetRelativeHeightSummaryAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			PreparedStatement stmt = conn.prepareStatement(SqlQuery.GET_EXPERIMENT_DETAILS_REL_HEIGHT.getSql());
