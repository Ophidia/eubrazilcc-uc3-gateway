...
public class GetClimateSebalResultsAction extends ActionSupport {
	...
	public String execute() throws Exception {
		...
		try {
			...
			while(rs.next()) {
				...
				prop.load(GetClimateSebalResultsAction.class.getClassLoader().getResourceAsStream("configs.properties"));
				String path = "";
