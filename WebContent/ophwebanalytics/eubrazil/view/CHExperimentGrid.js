...
Ext.define('Eubrazil.view.CHExperimentGrid',{
    ...
    columns: [{text: 'Experiment Name', flex: 1, dataIndex: 'experimentname'},
              ...
              {text: 'Map',             flex: 0.7, dataIndex: 'color', renderer: function (val) {
            	  var result = '';
            		  result = ' <svg width="50" height="15"><rect width="50" height="15" style="fill:' + val + ';fill-opacity:0.35;stroke-width:3;stroke:' + val + ';stroke-opacity:0.8" /></svg> ';
            		  return result;
