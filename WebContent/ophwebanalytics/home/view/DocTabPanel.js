...
/*Ext.define('Home.view.DocTabPanel', {
	...
	items: [{
		...
		html: '<p class="home-text-doc">The following documentation corresponds to the latest stable release of BioClimate the EUBrazilCC Scientific Gateway on Biodiversity and Climate Change, released on July 31, 2015.<br><br>BioClimate is available on github at the following link: <a href="https://github.com/Ophidia/eubrazilcc-uc3-gateway">https://github.com/Ophidia/eubrazilcc-uc3-gateway</a><br><br><br><br><br>Please contact us at info-bioclimate [at] eubrazilcc [dot] eu if you want to contribute to the source code implementation.</p>'
	},{
		xtype : 'panel',
		height: 350,
		border: false,
		...
		html: '<p class="home-text-doc-bold">Papers</p><p class="home-text-doc"><br>Sandro Fiore, Marco Mancini, Donatello Elia, Paola Nassisi, Francisco Vilar Brasileiro, Ignacio Blanquer, Iana A. A. Runo, Arie C. Seijmonsbergen, Carlos de Oliveira Galvao, Vanderlei Perez Canhos, Andrea Mariello, Cosimo Palazzo, Alessandra Nuzzo, Alessandro D\'Anca, Giovanni Aloisio, Big data analytics for climate change and biodiversity in the EUBrazilCC federated cloud infrastructure. Conf. Computing Frontiers 2015: 52:1-52:8</p>'
	}]
});*/
		...
		},
		{
			...
			items: [{
				...
				items: [{
					...
					'<p class="home-text-doc">1.	Select the Interannual analysis tab on the left. ' + 
			    ...
			    },
			    {
					...
					'<p class="home-text-doc">4.	Select one SEBAL variable. ' + 
